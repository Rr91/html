...
(function($, window, document) {
    var Cross2 = {
        ...
        init: function(options, el) {
            ...
            this.$before = $('<div style="position: absolute;width:0;" class="cross2-item cross2-item-before resize"><b></b></div>');
            this.$after = $('<div style="position: relative" class="cross2-item cross2-item-after"><b class="bb2"></b></div>');
            ...
            if (base.options.mousemoveEnabled == false) {
                this.$slider = $('<a class="cross2-slider handle"><span></span></a>');
            } else {
        ...
        setOffset: function(offset) {
            ...
            var k = this.options.vertical == true ? this.height : $('#container').width();
            ...
            this.$before.css('width', clip);
            this.$before.next().find('.bb2').css('width', this.width - clip);
            return this;
        },
        set: function(val) {
            var k = this.options.vertical == true ? this.height : this.width;
        ...
        moveToOffset: function(offset) {
            ...
            var animationOptions = {
                ...
                step: function() {
                    base.setOffset(parseInt(base.$slider.css(offsetType)));
                },
                complete: function() {
                    base.setOffset(parseInt(base.$slider.css(offsetType)));
                }
